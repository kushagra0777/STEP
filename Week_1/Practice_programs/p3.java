public class p3 {
    ...
    public static String[] formatNames(String[] names) {
        ...
        for (int i = 0; i < names.length; i++) {
            ...
            if (parts.length >= 2) formatted[i] = parts[1] + ", " + parts[0];
            else formatted[i] = names[i];
        }
        return formatted;
    }

    public static void main(String[] args) {
        String[] students = {"Kushagra Goel", "Aakarsh Kumar", "Aniket Srivastava", "Kartikey Bhatt"};
        ...
        for (String name : formatted) System.out.println(name);
    }
}
